...
variable "deploy_nim" {
  type        = bool
  default     = true
  description = "Controls the deployment of the NIM MolMIM helm chart."
}

variable "nim_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the NIM MolMIM helm chart defaults and those generated by Terraform using the templates."
}
...
variable "jupyter_playbooks_repo" {
  type        = string
  default     = "https://github.com/robo-cap/molmim-jupyter-notebooks.git"
...
variable "nim_image_repository" {
  type        = string
  default     = "nvcr.io/nim/nvidia/molmim"
